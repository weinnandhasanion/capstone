          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <div class="form-row">
                <div class="col-sm-6">
                  <label>First Name</label>
                  <input name="first_name" type="text" onblur="checkIfValid(this)" id="update_fname" readonly
                    class="form-control">
                ...
                <div class="col-sm-6">
                  <label>Last Name</label>
                  <input name="last_name" type="text" onblur="checkIfValid(this)" id="update_lname" readonly
                    class="form-control">
            ...
            <div class="form-group">
              <div class="form-row">
                <div class="col-sm-6">
                  ...
                  <input name="phone" type="text" required id="update_phone" onblur="checkNumber(this)"
                    class="form-control">
            ...
            <div class="form-group">
              <div class="form-row">
                <div class="col-sm-12">
                  ...
                  <input name="email" required onblur="checkEmail(this)" type="email" id="update_email"
                    class="form-control">
