  ...
  searchDel.onkeyup = () => {
    ...
    deldeldel = (docs) => {
      ...
      docs.forEach((doc) => {
        ...
        let add = new Date(doc.doc.dateAdded.toDate());
        let del = new Date(doc.doc.dateDeleted.toDate());
          tr.setAttribute('data-id', doc.id);
          tr.innerHTML = 
          `
          <td><b>${doc.fullName}</b></td>
          ...
          data-toggle="tooltip" data-placement="top" title="Recover ${doc.doc.lname}"
