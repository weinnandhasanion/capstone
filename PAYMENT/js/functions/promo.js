...
//search Delete
let searchDel = document.getElementById('search_delete');
...
deleteTable = (docs) => {
  let promoCont = document.getElementById('tbody');
  promoCont.innerHTML = '';
    ...
    tr.innerHTML = 
      ...
      <td>
       ...
       <i id="deleteBtn" onclick='recoverPro(this.parentNode.parentNode)'
           data-toggle="tooltip" data-placement="top" title="Recover ${doc.data.promoname}"
...
renderCard = () => {
  ...
  card.innerHTML = 
    ...
    <div class="card-footer">
      <button class="btn btn-sm btn-orange">view</button>

      <button  onclick='updatefunction(this.parentNode.parentNode)' 
      data-toggle='modal' data-target='#update' 
       class="btn btn-sm btn-orange">UPDATE</button>
