...
if($timespan == "Custom") {
  ...
  $sql = "SELECT * FROM paymentlog
          WHERE payment_description = 'Annual Membership'
          ORDER BY payment_id DESC";
  $res = mysqli_query($conn, $sql);
}
...
$labels = array("Payment ID", "Payer Name", "Payment Amount", "Date and Time of Payment");
$rowLabels = array("payment_id", "name", "amount", "datetime");
...
$object = (object) [
  ...
  'toDate' => $toDate,
  'fromDate' => $fromDate,
  'reportTitle' => "List of annual membership payments",
  'timespan' => $timespan,
