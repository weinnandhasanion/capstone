...
$labels = array("Payment ID", "Payer Name", "Payment Description", "Payment Amount", "Date and Time of Payment");
$rowLabels = array("payment_id", "name", "payment_description", "amount", "datetime");
...
$description = "Generated a report for list of total sales";
$identity = "Reports";
$timeNow = date("h:i A");
$user_fname = "total sales";
